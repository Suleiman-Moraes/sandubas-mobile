...
import { SANDU_PEDIDO, SANDU_PEDIDO_GETPEDIDO, SANDU_PEDIDO_ADICIONAR, SANDU_PEDIDO_USER, SANDU_PEDIDO_COMPRAR } from './sandubas.api';
...
export class PedidoService {
  ...
  comprar(pedido: Pedido): Observable<ResponseApi> {
    return this.http.put(`${SANDU_PEDIDO_COMPRAR}`, pedido).pipe(
      map(this.fromJsonResponseApi.bind(this)),
      catchError(this.handleError)
    );
  }
